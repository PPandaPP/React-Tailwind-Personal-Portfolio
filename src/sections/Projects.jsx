...
const projects = [
    {
        title: "Casacomfort VIP management APP",
    ...
    {
        title: "ITSM Helpdesk Application",
        ...
        <div className="container mx-auto px-6 relative z-10">
            ...
            <div className="text-center mx-auto max-w-3xl mb-16">
                ...
                <h2 className="text-4xl md:text-5xl font-bold mt-4 mb-6 animate-fade-in animation-delay-100 text-secondary-foreground">
                    ...
                    <span className="font-serif text-sm italic animate-fade-in animation-delay-800"> (not really) </span>
                </h2>
            ...
            {/* View All CTAs */}
            <div className="text-center mt-22 animate-fade-in animation-delay-500">
                <a href = "https://github.com/PPandaPP">
